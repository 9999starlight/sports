...
export const getGroupList = createSelector(getAppState, state => state.groupList)
export const getGroupEvents = createSelector(getAppState, state => state.eventsList)